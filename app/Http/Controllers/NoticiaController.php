...
/*
        if(Cache::has('10_primeiras_noticias')){
            //Recuperar o dado dentro do BD Redis
            $noticias = Cache::get('10_primeiras_noticias');
        }else{
            $noticias = Noticia::orderByDesc('created_at')->limit(10)->get();
            //Criar um dado dentro do BD Redis
            Cache::put('10_primeiras_noticias', $noticias, 20);
        }
*/
        $noticias = Cache::remember('10_primeiras_noticias', 15, function () {
